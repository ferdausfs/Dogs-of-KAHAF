...
object GuardianConstants {
    ...
    // Raised thresholds → less false positives
    const val NSFW_GATE_THRESHOLD         = 0.78f   // was 0.60
    const val GENDER_CONFIDENCE_THRESHOLD = 0.78f   // was 0.65
    const val EARLY_EXIT_RATIO            = 0.35f   // was 0.20

    // Need 3 strikes now instead of 2
