...
// R7.7 — multi-window schedules: PK moved from packageName to an
// autogenerated id so one app can hold several windows (e.g. prayer-time
// 12:00–14:00 AND night 22:00–06:00). MIGRATION_4_5 preserves all rows.
